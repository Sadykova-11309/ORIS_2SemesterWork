...
//Project:	EV Admin Admin - Responsive Admin Template
//Primary use:	EV Admin Admin - Responsive Admin Template
...
// Dynamic active menu
    var path = window.location.pathname.split("https://ev-admin-dashboard-template.multipurposethemes.com/").pop();
